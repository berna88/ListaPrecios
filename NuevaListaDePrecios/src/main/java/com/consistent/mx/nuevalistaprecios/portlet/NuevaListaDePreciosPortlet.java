package com.consistent.mx.nuevalistaprecios.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=NuevaListaDePrecios",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + NuevaListaDePreciosPortletKeys.NUEVALISTADEPRECIOS,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class NuevaListaDePreciosPortlet extends MVCPortlet {
	
	private static Log log = LogFactoryUtil.getLog(NuevaListaDePreciosPortlet.class.getName());
